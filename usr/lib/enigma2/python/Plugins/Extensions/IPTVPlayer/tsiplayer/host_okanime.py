...
def getinfo():
    ...
    info_['icon']='https://i.ibb.co/Yb8HbHb/Okanime.png'
...
class TSIPHost(TSCBaseHostClass):
    ...
    def showmenu0(self,cItem):
        hst='host2'
        img_=cItem['icon']
        self.addMarker({'title':tscolor('\c00????30') +'أفلام','category' : 'host2','icon':img_} )
        ...
        self.addMarker({'title':tscolor('\c00????30') +'قائمة الانميات','category' : 'host2','icon':img_} )
        Cat_TAB = [
