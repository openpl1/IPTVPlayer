...
class cHoster(iHoster):
    ...
    def _getMediaLinkForGuest(self):
        ...
        headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:68.0) Gecko/20100101 Firefox/68.0', 'Referer': referer}
        ...
        s = requests.Session()
        headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:68.0) Gecko/20100101 Firefox/68.0', 'Referer': referer, 'X-Requested-With': 'XMLHttpRequest'}
