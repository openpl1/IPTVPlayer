...
def getinfo():
    ...
    info_['icon'] = 'https://i.ibb.co/0hTgDmF/livetv.png'
...
class TSIPHost(TSCBaseHostClass):
    ...
    def showitms(self, cItem):
        ...
        if sts:
            ...
            for (titre, image, bitrate, qualite, url, type_) in data_els:
                ...
                if bitrate != '':
                    titre = titre + tscolor('\c0000????') + ' ('+bitrate+')'
                        ...
                        if sts:
                            ...
                            if data_els:
                                ...
                                if url_.startswith('//'):
                                    url_ = 'http:' + url_
                                color_ = tscolor('\c00??????')
                                if 'all.ive.zone' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'popofthestream' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'wizhdlive' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'ettu.tv' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'gamehub' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'onionstream' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'allsport.icu' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'telerium' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'sportrush.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'ocubel.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'livecenter.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'onhockey.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'vimeo.' in url_:
                                ...
                                if '.socolive' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'sports247.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'soccerstreamslive.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'jokerswidget.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'klubsports.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'streamhd247' in url_:
                                    color_ = tscolor('\c00????20')
                                if 'maxsport' in url_:
                                    color_ = tscolor('\c00????20')
                                if 'livetvon' in url_:
                                    color_ = tscolor('\c00??2020')
                                if 'sportcast' in url_:
                                    color_ = tscolor('\c00??2020')
                                if 'varplatform' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'embedstream' in url_:
                                    color_ = tscolor('\c00??20??')
                                color_ = tscolor('\c00??????')
                                if 'varplatform' in url_:
                                    color_ = tscolor('\c00??2020')
                                if 'xestreams.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'sawlive' in url_:
                                    color_ = tscolor('\c0020??20')
                                ...
                                if 'maxsport' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'soccerstream100' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'sportskart' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'daddylivehd' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'livestream' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'stream.crichd' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'assia24' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'sports-stream.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'ustream.' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'brolel.' in url_:
                                ...
                                if 'embedstream' in url_:
                                    color_ = tscolor('\c00??20??')
                                if '1socolive' in url_:
                                    color_ = tscolor('\c00??20??')
                                if 'streamhd247' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'wizospor' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'streamingnow' in url_:
                                    color_ = tscolor('\c0020??20')
                                if '1l1l.to' in url_:
                                    color_ = tscolor('\c0020??20')
                                if 'spotles365' in url_:
                                    color_ = tscolor('\c0020??20')
    ...
    def resolve_links(self, url, referer, ipaudio=False):
        ...
        if 'ettu.tv' in url:
            return (self.resolve_EttuTv(url))
        if 'emb.apl' in url:
            return (self.resolve_EMB(url, ipaudio))
        if 'cdn122.com' in url:
            return (self.resolve_CDN(url, referer, ipaudio))
        if 'sawlive.tv' in url:
            return (self.resolve_SawLive(url, ipaudio))
        if 'livestream.' in url:
            return (self.resolve_LiveStream(url, ipaudio))
        if 'wecast.to' in url:
            return (self.resolve_Wecast(url, referer, ipaudio))
        if 'vimeo.com' in url:
            return ([{'name': 'vimeo', 'url': url, 'need_resolve': 1},])
        ...
        if data_els:
            ...
            if ipaudio:
                self.addtoipaudio({'url': url_, 'titre': url_})
        ...
        if sts:
            ...
            if data_els:
                ...
                if Embed_URL.strip() != '':
                    ...
                    if Embed_URL.startswith('./aliez/'):
                        Embed_URL = Embed_URL.replace('./aliez/', 'http://www.popofthestream.com/embed/aliez/')
                    if Embed_URL.startswith('/'):
                        Embed_URL = 'http://' + gethostname(url) + Embed_URL
                ...
                for (data0, titres) in data_els:
                    ...
                    for titre in titre_:
                        ...
                        for titre0, url in data_els:
                            ...
                            if '1l1l' in url:
                                titre0 = titre0 + ' (1l1l.to)'
                            elif 'l1l1' in url:
                                titre0 = titre0 + ' (l1l1.to)'
                            elif 'bedsport' in url:
                                titre0 = titre0 + ' (bedsport.live)'
