...
def showMovies(sSearch=''):
    ...
    if aResult[0]:
        ...
        for aEntry in aResult[1]:
            ...
            sTitle = aEntry[2]
            siteUrl = aEntry[0]
            sThumb = re.sub(r'thumb\/\d*x\d*\/', '', aEntry[1])
            sDesc = ''
            sYear = ''
