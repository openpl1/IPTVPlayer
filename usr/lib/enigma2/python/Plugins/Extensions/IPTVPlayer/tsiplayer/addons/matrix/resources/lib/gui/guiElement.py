...
from Plugins.Extensions.IPTVPlayer.libs.xbmc import xbmc
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import (
    addon, isMatrix, isNexus)
...
class cGuiElement:
    ...
    def TraiteTitre(self, sTitle):
        ...
        try:
            ...
            sTitle = sTitle.replace(' - saison', ' season').replace(' – saison', ' season').replace(' — saison', ' season')
            ...
            sTitle = sTitle.replace("مدبلج بالعربية","مدبلج").replace("مدبلج بالعربي","مدبلج").replace("مدبلج عربي","مدبلج").replace("مدبلجة","مدبلجة").replace("مدبلجه","مدبلجة").replace("مدبلج بالمصري","مدبلج بالمصري").replace("مدبلج مصري","مدبلج بالمصري").replace("مدبلج للعربية","مدبلج").replace("مدبلج","مدبلج")
