...
def gettytul():
    return 'https://altadefinizione01.bet/'


class Altadefinizione(CBaseHostClass):

    def __init__(self):
        CBaseHostClass.__init__(self, {'history': 'altadefinizione01.bet', 'cookie': 'altadefinizione01.recipes.cookie'})
        ...
        self.MAIN_URL = 'https://www.altadefinizione01.bet/'
        self.DEFAULT_ICON_URL = 'https://www.altadefinizione01.bet/templates/Darktemplate_pagespeed/images/logo.png'
