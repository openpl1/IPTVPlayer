...
from Components.config import (ConfigDirectory, ConfigInteger, ConfigNothing,
                               ConfigOnOff, ConfigSelection, ConfigSubsection,
                               ConfigText, ConfigYesNo, NoSave, config,
                               configfile, getConfigListEntry)
from Plugins.Extensions.IPTVPlayer.components.configbase import (
    COLORS_DEFINITONS, ConfigBaseWidget)
...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    CFakeMoviePlayerOption, GetAvailableIconSize, GetEnabledHostsList,
    GetHostsList, GetSkinsList, IsExecutable, IsWebInterfaceModuleAvailable,
    SetGraphicsHash, SetIconsHash, defaultToolPath, isOPKGinstall, printDBG,
    printExc)
...
if isOPKGinstall():
    ...
    config.plugins.iptvplayer.preferredupdateserver = ConfigSelection(default="2", choices=[("", _("Default")), ("1", "http://iptvplayer.vline.pl/"), ("2", _("http://MOHAMED_OS.gitlab.io/")), ("3", _("private"))])
...
config.plugins.iptvplayer.gitlab_repo = ConfigSelection(default="MOHAMED_OS", choices=[("mosz_nowy", "mosz_nowy"), ("MOHAMED_OS", "MOHAMED_OS"), ("maxbambi", "maxbambi")])
