...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (eConnectCallback,
                                                           printDBG, printExc)
from Screens.HelpMenu import HelpableScreen
from Screens.InfoBarGenerics import (InfoBarAudioSelection,
                                     InfoBarNotifications, InfoBarSeek,
                                     InfoBarShowHide, InfoBarSubtitleSupport)
...
class customMoviePlayer(InfoBarShowHide, InfoBarSeek, InfoBarAudioSelection, InfoBarAspectSelection ,InfoBarSubtitleSupport, HelpableScreen, InfoBarNotifications, Screen):
    ...
    def __init__(self, session, service, lastPosition=None, bugEOFworkaround=0):
        ...
        for x in HelpableScreen, InfoBarShowHide, InfoBarSeek, InfoBarAudioSelection,  InfoBarAspectSelection,InfoBarSubtitleSupport, InfoBarNotifications:
            x.__init__(self)
