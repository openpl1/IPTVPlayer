...
from Plugins.Extensions.IPTVPlayer.components.configgroups import \
    ConfigGroupsMenu
...
from Plugins.Extensions.IPTVPlayer.components.ihost import (ArticleContent,
                                                            ...
                                                            CFavItem, CUrlItem,
                                                            IHost, RetHost)
from Plugins.Extensions.IPTVPlayer.components.iptvarticlerichvisualizer import \
    IPTVArticleRichVisualizer
...
from Plugins.Extensions.IPTVPlayer.components.iptvextmovieplayer import \
    IPTVExtMoviePlayer
...
from Plugins.Extensions.IPTVPlayer.components.iptvlist import \
    IPTVMainNavigatorList
from Plugins.Extensions.IPTVPlayer.components.iptvpictureplayer import \
...
from Plugins.Extensions.IPTVPlayer.components.iptvplayerinit import (
    GetIPTVNotify, GetIPTVPlayerLastHostError, GetIPTVSleep,
    IPTVPlayerNeedInit)
from Plugins.Extensions.IPTVPlayer.components.iptvplayerinit import \
    TranslateTXT as _
from Plugins.Extensions.IPTVPlayer.components.playerselector import \
    PlayerSelectorWidget
from Plugins.Extensions.IPTVPlayer.iptvdm.iptvbuffui import \
...
from Plugins.Extensions.IPTVPlayer.iptvdm.iptvdownloadercreator import \
    IsUrlDownloadable
from Plugins.Extensions.IPTVPlayer.iptvupdate.updatemainwindow import (
    IPTVUpdateWindow, UpdateMainAppImpl)
from Plugins.Extensions.IPTVPlayer.libs.pCommon import CParsingHelper
from Plugins.Extensions.IPTVPlayer.libs.urlparser import urlparser
from Plugins.Extensions.IPTVPlayer.p2p3.manipulateStrings import ensure_str
from Plugins.Extensions.IPTVPlayer.p2p3.pVer import isPY2, pVersion
from Plugins.Extensions.IPTVPlayer.p2p3.UrlLib import urllib_quote
from Plugins.Extensions.IPTVPlayer.setup.iptvsetupwidget import \
    IPTVSetupMainWidget
...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    ...
    CMoviePlayerPerHost, CSearchHistoryHelper)
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import \
    FreeSpace as iptvtools_FreeSpace
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    GetAvailableIconSize, GetE2VideoMode, GetEnabledHostsList,
    GetExtensionsDir, GetHostsAliases, GetHostsList, GetHostsOrderList,
    GetIconDir, GetIPTVPlayerVerstion, GetPluginDir, GetSkinsDir,
    GetUpdateServerUri, GetVersionNum, IsExecutable, IsHostEnabled,
    SaveHostsOrderList, SetE2VideoMode, SetTmpCookieDir, SetTmpJSCacheDir,
    SortHostsList, TestTmpCookieDir, TestTmpJSCacheDir, eConnectCallback,
    formatBytes, getExcMSG, getIPTVplayerOPKGVersion, iptv_system)
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import \
...
class E2iPlayerWidget(Screen):
    ...
    def __init__(self, session):
        ...
        if None == gDownloadManager:
            from Plugins.Extensions.IPTVPlayer.iptvdm.iptvdmui import \
                GetIPTVDMNotification
    ...
    def blue_pressed(self):
        ...
        # For subtitles test
        if False:
            from Plugins.Extensions.IPTVPlayer.components.iptvsubdownloader import \
                IPTVSubDownloaderWidget
        ...
        if self.visible or 'sequencer' == eventFrom:
            ...
            if sel is None:
                ...
                if item.type in [CDisplayListItem.TYPE_VIDEO, CDisplayListItem.TYPE_AUDIO, CDisplayListItem.TYPE_PICTURE, CDisplayListItem.TYPE_DATA]:
                    ...
                    if item.pinLocked:
                        from Plugins.Extensions.IPTVPlayer.components.iptvpin import \
                            IPTVPinWidget
                ...
                if caps.get('has_suggestions') and config.plugins.iptvplayer.osk_allow_suggestions.value:
                    ...
                    if suggestionsProvider == None:
                        ...
                        if providerAlias == 'filmweb':
                            from Plugins.Extensions.IPTVPlayer.suggestions.filmweb import \
                                SuggestionsProvider as filmweb_Provider
                            suggestionsProvider = filmweb_Provider()
                        elif providerAlias == 'imdb':
                            from Plugins.Extensions.IPTVPlayer.suggestions.imdb import \
                                SuggestionsProvider as imdb_Provider
                            suggestionsProvider = imdb_Provider()
                        elif providerAlias == 'google':
                            from Plugins.Extensions.IPTVPlayer.suggestions.google import \
                                SuggestionsProvider as google_Provider
                            suggestionsProvider = google_Provider()
                        elif providerAlias == 'filmstarts':
                            from Plugins.Extensions.IPTVPlayer.suggestions.filmstarts import \
                                SuggestionsProvider as filmstarts_Provider
                            suggestionsProvider = filmstarts_Provider()

                    if suggestionsProvider:
                        from Plugins.Extensions.IPTVPlayer.components.e2ivksuggestion import \
                            AutocompleteSearch
