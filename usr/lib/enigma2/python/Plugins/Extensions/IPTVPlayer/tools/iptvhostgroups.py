...
class IPTVHostsGroups:
    def __init__(self):
        ...
        # groups
        self.PREDEFINED_GROUPS = ["userdefined", "tsiplayer", "moviesandseries", "cartoonsandanime", "music", "sport", "live", "documentary", "science",
                                  "polish", "english", "german", "french", "hungarian", "greek", "latino", "italian", "swedish", "balkans", "others"]
        ...
        self.PREDEFINED_HOSTS['userdefined'] = ['favourites', 'localmedia', 'youtube', 'webstream', 'dailymotion', 'vimeo', 'twitchtv', 'iptvplayerinfo']
        self.PREDEFINED_HOSTS['tsiplayer'] = ['tsiplayer', 'youtube']
        self.PREDEFINED_HOSTS['moviesandseries'] = ['appletrailers', 'efilmytv', 'ekinotv', 'cdapl', 'vizjerpl', 'zaluknijcc', 'filman', 'hdseanspl', 'filmowoclub', 'freediscpl', 'zerioncc'
                                                    ...
                                                    'obejrzyjto','tfarjocom', 'filmaoncom', 'filmstreamhdit', 'altadefinizione', 'streaminghdfun', 'putlockertvto', 'filmehdnet', 'andrijaiandjelka',
                                                    'altadefinizione01', '123movieshd', 'filma24io', 'officialfilmillimite', 'ddl', 'hdfull', 'dixmax', 'fenixsite', 'kkiste']
        self.PREDEFINED_HOSTS['cartoonsandanime'] = ['bajeczkiorg', 'animeodcinki', '9anime', 'kisscartoonme', 'watchcartoononline', 'otakufr']
        self.PREDEFINED_HOSTS['sport'] = ['meczykipl', 'ekstraklasatv', 'laola1tv', 'bbcsport', 'ourmatchnet', 'hoofootcom', 'okgoals', 'ngolos',
                                          'watchwrestlinguno', 'watchwrestling', 'fighttube', 'fightvideo', 'pinkbike', 'sportdeutschland', 'eurosportplayer', 'del', 'redbull', 'fullmatchtvcom']
        self.PREDEFINED_HOSTS['live'] = ['streamliveto', 'ustreamtv', 'eskago', 'eurosportplayer', 'ustvgo']
        self.PREDEFINED_HOSTS['documentary'] = ['fokustv', 'dokumentalnenet', 'greekdocumentaries3', 'orthobulletscom', 'vumedicom']
        self.PREDEFINED_HOSTS['science'] = ['questtvcouk', 'ustreamtv', 'dokumentalnenet', 'orthobulletscom', 'vumedicom']
        self.PREDEFINED_HOSTS['polish'] = ['efilmytv', 'ekinotv', 'cdapl', 'vizjerpl', 'zaluknijcc', 'filman', 'hdseanspl', 'obejrzyjto', 'zerioncc', 'tvpvod', 'ipla',
        ...
        self.PREDEFINED_HOSTS['english'] = ['bbciplayer', 'bbcsport', 'tvplayercom', 'itvcom', 'uktvplay', 'appletrailers', 'classiccinemaonline', 'seriesonline',
                                            'thewatchseriesto', 'movienightws', 'artetv', 'hdpopcornscom', 'losmovies', 'solarmovie', 'putlockertvto', 'vumooch', 'cineto', 'cartoonhd', '9anime', 'kisscartoonme', 'watchcartoononline',
                                                    'ourmatchnet', 'watchwrestlinguno', 'watchwrestling', 'laola1tv', 'hoofootcom', 'fightvideo', 'ted', 'ororotv', 'pinkbike', 'dancetrippin', 'appletrailers',
                                                    'ustreamtv', 'rteieplayer', '3player', 'questtvcouk', 'filmeonlineto', 'playrtsiw', '123movieshd', 'orthobulletscom', 'vumedicom', 'ddl']
        self.PREDEFINED_HOSTS['german'] = ['ardmediathek', 'zdfmediathek', 'artetv', 'tvnowde', 'spiegeltv', 'ddl', 'hdstreams', 'serienstreamto', 'bsto', 'hdfilmetv', 'cineto', 'filmpalast', 'kinox', 'szenestreamz', 'tata',
                                                    'laola1tv', 'sportdeutschland', 'playrtsiw', 'del', 'kkiste']
        self.PREDEFINED_HOSTS['french'] = ['tfarjocom', 'skstream', 'filmstreamvkcom', 'streamcomplet', 'dpstreamingcx', 'librestream', 'cinemay', 'otakufr', 'rtbfbe', 'artetv', 'planetstreamingcom', 'playrtsiw', 'officialfilmillimite']
        ...
        self.PREDEFINED_HOSTS['italian'] = ['cb01uno', 'mediasetplay', 'altadefinizione01', 'tantifilmorg', 'filmstreamhdit', 'playrtsiw', 'altadefinizione', 'streaminghdfun', 'raiplay', 'dplayit']
        ...
        self.PREDEFINED_HOSTS['music'] = ['vevo', 'myfreemp3', 'musicmp3ru', 'dancetrippin', 'musicbox', 'shoutcast', 'eskago', 'radiostacja', 'nuteczki', 'mediayou']
