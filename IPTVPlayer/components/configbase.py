...
from Plugins.Extensions.IPTVPlayer.components.iptvdirbrowser import (
    IPTVDirectorySelectorWidget, IPTVFileSelectorWidget)
...
from Components.config import (ConfigBoolean, ConfigDirectory, ConfigPassword,
                               ConfigSelection, ConfigText, configfile)
