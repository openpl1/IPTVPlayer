...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.handler.pluginHandler import \
    cPluginHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.upnext import \
    UpNext
...
class cPlayer(xbmc.Player):
    ...
    def __setWatchlist(self, sEpisode=''):
        ...
        if self.ADDON.getSetting('bstoken') == '':
            return
        plugins = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.trakt', fromlist=['trakt']).cTrakt()
