...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import (
    VSlog, addon, dialog, isKrypton, isNexus, listitem, progress, window)
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.gui.contextElement import \
    cContextElement
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.gui.guiElement import \
    cGuiElement
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.handler.pluginHandler import \
    cPluginHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.tmdb import \
    cTMDb
...
class cGui:
 ...
 #affiche tag HD
    ...
    def viewBA(self):
        ...
        from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.ba import \
            cShowBA
        cBA = cShowBA()
    ...
    def viewInfo(self):
        if addon().getSetting('information-view') == "false":
            from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.config import \
                WindowsBoxes
    ...
    def setWatched(self):
        if True:
            ...
            from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.db import \
                cDb
            with cDb() as db:
