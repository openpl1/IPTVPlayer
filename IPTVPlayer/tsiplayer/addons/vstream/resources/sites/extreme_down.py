...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import (
    VSlog, addon, dialog, siteManager)
...
MOVIE_NEWS = (URL_MAIN + '?p=films', 'showMovies')
...
def showMenuMovies():
    ...
    oGui.addDir(SITE_IDENTIFIER, MOVIE_NEWS2021[1], 'Films (Nouveautés)', 'news.png', oOutputParameterHandler)
...
def showHosters():
    ...
    if Token_Alldebrid != "":
        ...
        test = recaptcha_v2.UnCaptchaReCaptcha().processCaptcha("6LeH9lwUAAAAAGgg9ZVf7yOm0zb0LlcSai8t8-2o", referer=sUrl)
