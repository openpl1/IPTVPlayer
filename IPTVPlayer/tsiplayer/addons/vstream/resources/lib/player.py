...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import (
    VSlog, addon, addonManager, dialog, isKrypton)
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.handler.pluginHandler import \
    cPluginHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.upnext import \
    UpNext
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.util import (
    Unquote, cUtil, urlHostName)
...
class cPlayer(xbmc.Player):
    ...
    def __setWatchlist(self, sEpisode=''):
        ...
        if self.ADDON.getSetting('bstoken') == '':
            return
        plugins = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.trakt', fromlist=['trakt']).cTrakt()
