...
def getinfo():
    ...
    info_['icon'] = 'https://i.ibb.co/80LM88h/cimau.png'
...
class TSIPHost(TSCBaseHostClass):
    def __init__(self):
        ...
        self.MAIN_URL2 = 'https://tv5.cima4u7.site'
    ...
    def showmenu0(self, cItem):
        ...
        Cima4u_TAB = [
            ...
            {'category': hst, 'title': T('Search'), 'icon': cItem['icon'], 'mode': '50'},]
    ...
    def get_links(self, cItem):
        ...
        if sts:
            ...
            for (code, host_) in Liste_els:
                ...
                if 'thevids' in host_.lower():
                    host_ = 'thevideobee'
                if 'up-stream' in host_.lower():
                    host_ = 'uptostream'
        ...
        if sts:
            ...
            if lst_dat:
                ...
                for (x1, x2) in lst_dat2:
                    ...
                    if 'القسم' in x1:
                        otherInfo1['categories'] = ph.clean_html(x2)
                    if 'الجودة' in x1:
