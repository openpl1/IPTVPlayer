...
def getinfo():
    ...
    info_['icon'] = 'https://i.ibb.co/nDjyfNg/lodynet.png'
...
class TSIPHost(TSCBaseHostClass):
    ...
    def showmenu1(self, cItem):
        ...
        if gnr == 0:
            TAB = [('مسلسلات هندية', '/category/مسلسلات-هنديه/', '20', ''), ('مسلسلات هندية مدبلجة', '/category/1dubbed-indian-series/', '20', ''),
            ...
            TAB = [('افلام هندية', '/category/افلام-هندية/', '20', ''), ('أفلام هندية مدبلجة', '/category/أفلام-هندية-مدبلجة/', '20', ''), ('افلام تركية مترجم', '/category/افلام-تركية-مترجم/', '20', ''),
