...
def gettytul():
    return 'https://cb01.observer/'


class Cb01(CBaseHostClass):

    def __init__(self):
        CBaseHostClass.__init__(self, {'history': 'cb01.observer', 'cookie': 'cb01.observer.cookie'})
        ...
        self.MAIN_URL = 'https://cb01.observer/'
        self.DEFAULT_ICON_URL = 'https://i0.wp.com/cb01.observer/wp-content/uploads/2021/01/logo-cb01-uno-film-streaming.jpg'
    ...
    def exploreItem(self, cItem):
        ...
        #example: <a href="https://stayonline.pro/l/knkN2/" target="_blank" rel="noopener noreferrer nofollow">Mixdrop</a>
