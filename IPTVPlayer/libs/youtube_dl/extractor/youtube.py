...
from Plugins.Extensions.IPTVPlayer.libs.youtube_dl.utils import (
    _unquote, compat_str, compat_urllib_parse)
...
from Plugins.Extensions.IPTVPlayer.p2p3.UrlLib import (urllib_unquote_plus,
                                                       urllib_urlencode)
from Plugins.Extensions.IPTVPlayer.tools.e2ijs import (is_js_cached,
                                                       js_execute_ext)
...
class YoutubeIE(object):
    ...
    def _extract_yt_initial_variable(self, webpage, regex, video_id, name):
        return json_loads(self._search_regex(
            (r'%s\s*%s' % (regex, self._YT_INITIAL_BOUNDARY_RE), regex), webpage, name, default='{}'))
