...
from Plugins.Extensions.IPTVPlayer.components.iptvplayerinit import \
    TranslateTXT as _
from Plugins.Extensions.IPTVPlayer.setup.iptvsetuphelper import (
    CBinaryStepHelper, CCmdValidator, SetupDownloaderCmdCreator)
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import (
    GetBinDir, GetPyScriptCmd, GetResourcesServerUri, GetTmpDir,
    IsFPUAvailable, ReadGnuMIPSABIFP, printDBG, printExc)
...
class IPTVSetupImpl:
    ...
    def getOpensslVersionFinished(self, stsTab, dataTab):
        ...
        if len(stsTab) > 0 and True == stsTab[-1]:
            for ver in ['0.9.8', '1.0.0', '1.0.2', '1.1.1','3.1.1']:
                if ver in dataTab[-1]:
