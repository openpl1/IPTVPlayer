...
from Plugins.Extensions.IPTVPlayer.p2p3.manipulateStrings import (
    ensure_str, iterDictItems, strDecode)
from Plugins.Extensions.IPTVPlayer.p2p3.UrlLib import (urllib2_HTTPError,
                                                       urllib2_Request,
                                                       urllib2_URLError,
                                                       urllib2_urlopen)
from Tools.Directories import (SCOPE_CONFIG, SCOPE_PLUGINS, fileExists,
                               resolveFilename)

SERVER_DOMAINS = {'vline': 'http://iptvplayer.vline.pl/', 'gitlab': 'https://gitlab.com/MOHAMED_OS/e2iplayer/-/raw/main/', 'private': 'http://www.e2iplayer.gitlab.io/'}
...
def GetIPTVPlayerVerstion():
    try:
        ...
        try:
            from Plugins.Extensions.IPTVPlayer.version import \
                Version as IPTV_VERSION  # from opkg
        except Exception:
